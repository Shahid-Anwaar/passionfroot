...
function PostCard({ post, path }: { post: BlogPost, path?: string }) {
  return (
    <Link href={`${path}${post.slug}`} className="group block border-2 border-transparent rounded-md hover:border-gray-950 p-5 hover:bg-[#ff9966]">
