...
export default function CreatorCtaSection({
  ...
  return (
    <section className="relative overflow-hidden bg-[#FFA465]">
      ...
      <div className="mx-auto max-w-[1440px] px-4 sm:px-6 lg:px-12 pt-10 sm:py-[58px] lg:py-[62px]">
        <div className="flex flex-col items-center text-center">
          {/* Title */}
          <h2 className="font-serif text-[#141414] text-[30px] sm:text-[54px] lg:text-[64px] leading-[1.06] tracking-[-0.01em] font-semibold">
          ...
          <div className="mt-7 sm:mt-8 flex flex-col sm:flex-row items-stretch sm:items-center justify-center gap-3 w-full sm:w-auto">
            <Link
              href="#"
              className="first-btn relative h-12 w-full sm:w-[160px] text-[14px] font-semibold"
            >
            ...
            <Link
              href="#"
              className="inline-flex h-12 w-full sm:w-[140px] items-center justify-center rounded-xl border border-black/15 bg-white text-[14px] font-semibold text-[#111111] shadow-[0_10px_22px_rgba(0,0,0,0.10)]"
            >
              Talk to us
            </Link>
          </div>
      ...
      {/* Bottom illustration */}
      {/* <div className="absolute -bottom-8 sm:-bottom-10 left-0 right-0 h-[150px] sm:h-[205px] lg:h-[215px]">
        <Image
