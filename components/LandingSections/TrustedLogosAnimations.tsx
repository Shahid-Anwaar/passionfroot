...
export default function TrustedLogosAnimation({
  logos = [],
  imageKey = "trusted_company_image", // <-- NEW
  imgClass = "h-8 md:h-10",           // <-- supports different heights
  wrapperHeight = "h-12 md:h-14",      // <-- supports different container heights
}: any) {
  ...
  return (
    <div className={`marquee flex-1 pt-2 min-w-0 w-full ps-3 ${wrapperHeight}`}>
      <div
